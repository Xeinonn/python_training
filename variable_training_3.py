#Short text to train variables
special_candy = "karameliki"
my_age = "8"
candy_form = "chicken"
print("When I was small, I liked a special candy, which was made of melted sugar. We called it as kids " + special_candy + ".")
